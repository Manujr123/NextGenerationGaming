...
GovGuns_Streamer()
{
	CreateDynamic3DTextLabel("Government Arms Center\n{DDDDDD}Press ~k~~CONVERSATION_YES~ to access the menu", COLOR_YELLOW, -2765.1582,382.1561,6.3281, 8.0);
	GovArmsPoint = CreateDynamicSphere(-2765.1582,382.1561,6.3281, 5.00);
}
